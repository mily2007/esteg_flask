...
def hide_message(message, image):
    ...
    binary_message = ''.join(format(ord(i), '08b') for i in message) + '1111111111111110' #terminador
...
def reveal_message(image):
    ...
    terminador = (1111111111111110)
    index_of_terminator = binary_message.find(terminador)

    # Se o terminador  for encontrador, cortar a mensagem
